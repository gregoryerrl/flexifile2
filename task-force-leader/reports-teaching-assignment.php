...
<body class="page-home">
      ...
      <div class="col-md-9">
        ...
        <div class="mt-3 p-3 thirteen-div rounded" style="height: auto;">
          ...
          <div class="my-3">
            ...
            <select name="ta_faculty_member" id="multi_option" multiple name="native-select" placeholder="Select" data-silent-initial-value-set="false"></select>
          </div>
          <div class="my-3">
            <label>Semester</label>
            <select name="ta_semester" id="multi_option" multiple name="native-select" placeholder="Select" data-silent-initial-value-set="false"></select>
          </div>
          <div class="text-end">
            <button name="ta_generate" class="btn btn-success mt-3">Generate</button>
          </div>
        </div>
  ...
  <script src="../resources/js/unobfuscated/task-force-leader-reports-teaching-assignment.js"></script>
