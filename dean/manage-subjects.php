...
<body class="page-home">
            ...
            <div class="row align-items-start mt-2" style="width: 50%; margin: 0 auto; ">
              <div class="col">
                ...
                <div class="input-group input-group-sm mb-3">
                  ...
                  <input type="text" name="subject_add_fte" class="form-control">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="modal-body">
            <div class="row align-items-start mt-2" style="width: 50%; margin: 0 auto; ">
              <div class="col">
                ...
                <div class="input-group input-group-sm mb-3">
                  <span class="input-group-text" id="inputGroup-sizing-sm">Full-Time Equivalent (FTE)</span>
                  <input type="text" name="subject_edit_fte" class="form-control">
                </div>
              </div>
            </div>
          </div>
  ...
  <script src="../resources/js/unobfuscated/dean-manage-subjects.js"></script>
