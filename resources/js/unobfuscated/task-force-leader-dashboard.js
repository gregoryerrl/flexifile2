$( document ).ready( function() {
  ...
  session.init().then( function() {
    dbQuery.execute( "Select * From academic_semester_tb Where Now() Between start_date And end_date; " ).then( function( e ) {
  ...
  btnSeePDS.click( function( e )     { redirect( rootURL + 'task-force-leader/view-pds.php' ); });
  btnSeeFiles.click( function( e )   { redirect( rootURL + 'task-force-leader/attachments.php' ); });
